...
# github.com/arca-network/arca-go-sdk.
#
# The Go SDK lives in this private monorepo at sdk/go, but its module path is
# github.com/arca-network/arca-go-sdk, so it is consumed from a dedicated public
...
#   go get github.com/arca-network/arca-go-sdk@<version>
set -euo pipefail
...
echo "Done. Install with: go get github.com/arca-network/arca-go-sdk@${VERSION:-latest}"
